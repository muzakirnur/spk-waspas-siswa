        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['attribute', 'nilai-attribute'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(1), ['attribute', 'nilai-attribute']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(1), ['attribute', 'nilai-attribute'])){{ 'hover:text-slate-200' }}@endif" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <i class="fa-solid fa-dollar-sign text-xl {{in_array(Request::segment(1),['attribute', 'nilai-attribute']) ? 'text-indigo-500' : 'text-slate-600'}}"></i>
                    ...
                    <!-- Mahasiswa -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['mahasiswa'])){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(1), ['mahasiswa'])){{ 'hover:text-slate-200' }}@endif" href="{{route('mahasiswa.index')}}">
                            <div class="flex items-center">
                    ...
                    <!-- Perhitungan -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['perhitungan'])){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(1), ['perhitungan'])){{ 'hover:text-slate-200' }}@endif" href="{{route('perhitungan.index')}}">
                            <div class="flex items-center">
                                <i class="fa-solid fa-calculator text-xl {{in_array(Request::segment(1),['perhitungan']) ? 'text-indigo-500' : 'text-slate-600'}}"></i>
                                <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Perhitungan SMART</span>
                            </div>
                        </a>
                    </li>
                    <!-- Hasil Perangkingan -->
